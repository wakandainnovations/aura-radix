...
const COLUMN_TOOLTIPS = {
  ...
  engrate: 'The share of viewers who actively interacted (likes + comments + shares ÷ views) — e.g. 3% means 3 of every 100 people who saw the post engaged with it. It measures audience responsiveness, not reach: a high rate signals a small but highly engaged audience, ideal for niche, high-conversion campaigns. Most channels sit in the 1–3% range, so 3% is at the healthy end of typical.',
  engagementrate: 'The share of viewers who actively interacted (likes + comments + shares ÷ views) — e.g. 3% means 3 of every 100 people who saw the post engaged with it. It measures audience responsiveness, not reach: a high rate signals a small but highly engaged audience, ideal for niche, high-conversion campaigns. Most channels sit in the 1–3% range, so 3% is at the healthy end of typical.',
