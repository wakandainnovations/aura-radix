...
// Admin-only control (rendered inside NewUISidebar) for switching between the
// demo-ready subset of nav sections/sub-tabs (see previewTabs.js) and full
// access to everything, including in-progress work. Lives in the sidebar's
// normal document flow (not a fixed page-level overlay) so it can't cover
// the notification bell or other controls in each section's header.
