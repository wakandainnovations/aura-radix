...
export default function AddCheckpointModal({ open, onOpenChange, entityId }) {
  ...
  const createMutation = useMutation({
    ...
    onError: (err) => setError(err?.message || 'Failed to create checkpoint'),
  });
  ...
  function handleSubmit(e) {
    ...
    createMutation.mutate({ entityId, checkpointDate, description: trimmed });
  }
